...
/**
 * The type Tv settings.
 */
class TvSettings extends DialogListener {

    private final NumberPicker channel;
     ...
     */
    TvSettings(Context context, TvDataSet dataSet, LayoutInflater layoutInflater, Inflater inflater) {
        ...
        list[0] = "Bild";
        System.arraycopy(channels, 0, list, 1, list.length - 1);
