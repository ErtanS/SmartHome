...
/**
 * The type Wall settings.
 */
class WallSettings extends DialogListener {
     ...
     */
    WallSettings(Context context, WallDataSet dataSet, LayoutInflater layoutInflater, Inflater inflater) {
     ...
     *
     * @param input ColorPicker für aktuelle Farbe
     * @param id    id
