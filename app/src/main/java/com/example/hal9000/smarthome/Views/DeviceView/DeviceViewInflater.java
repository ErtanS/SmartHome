...
public class DeviceViewInflater extends Inflater {
     ...
     * @param deviceType      soll gesetzt sein, wenn man von der Geräteübersicht diesen Konstruktor aufruft                   ansonsten null
     * @param deviceRoom      soll gesetzt sein, wenn man von der Raumübersicht diesen Konstruktor aufruft                   ansonsten null
     * @param fragmentManager the fragment manager
     */
    DeviceViewInflater(LinearLayout parentView, LayoutInflater inflater, Context context, String deviceType, String deviceRoom, FragmentManager fragmentManager) {
     ...
     * Button changer.
     *
     * @param clickedId   the clicked id
